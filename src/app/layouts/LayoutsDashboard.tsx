...
const s: Record<string, React.CSSProperties> = {
  ...
  user:  { display: 'flex', alignItems: 'center', gap: 14, fontSize: 13, flexWrap: 'wrap' },
  main:  { maxWidth: 1100, margin: '0 auto', padding: 'clamp(18px, 4vw, 32px) clamp(14px, 4vw, 28px)' },
  toolbar: {
    display: 'flex', justifyContent: 'space-between', alignItems: 'center',
    marginBottom: 20, gap: 12, flexWrap: 'wrap',
  },
  h1:    { margin: 0, fontSize: 'clamp(18px, 3.5vw, 22px)', fontWeight: 600 },
  h2:    { margin: 0, fontSize: 'clamp(16px, 3vw, 18px)', fontWeight: 600 },
  sectionBreak: { marginTop: 36, marginBottom: 14 },
  hint:  { fontSize: 12, color: '#64748b', marginTop: 4 },
  primary: {
    padding: '10px 14px', background: '#2563eb', border: 'none', borderRadius: 6,
  ...
  discreetLink: {
    ...
    cursor: 'pointer', fontSize: 12, padding: '6px 10px', textDecoration: 'none',
  },
  empty: {
  ...
  cardName: { fontSize: 15, fontWeight: 600, wordBreak: 'break-word' },
